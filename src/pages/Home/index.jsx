  ...
  return (
    <div className="flex gap-4 h-[500px] xl:h-[680px] justify-between  m-auto w-[80%] items-center">
      <div className="flex flex-col gap-5">
        <div className="w-[320px]  h-[200px] lg:w-[360px] xl:w-[490px] lg:h-[290px] bg-blue-950  rounded-xl flex justify-center flex-col shadow-black shadow-2xl">
          <div className="flex justify-center flex-col items-center gap-3 ">
            <h1 className="text-3xl lg:text-4xl xl:text-6xl text-white">DISCOVER</h1>
            <h2 className="text-xl lg:text-2xl xl:text-3xl text-white">Investment Opportunities</h2>
            <button className="w-[80%] lg:w-[68%] rounded-xl m-auto py-1 text-lg lg:text-2xl text-center text-black bg-yellow-500 ">
              Click here
            </button>
          </div>
        </div>
        <div className=" w-[320px] lg:w-[360px] xl:w-[490px] h-[100px] bg-blue-950  rounded-xl flex justify-between text-white items-center px-6 shadow-black shadow-2xl gap-3">
      ...
      <div className="w-[360px] h-[360px] lg:h-[450px] lg:w-[450px] xl:w-[480px] xl:h-[480px] rounded-xl shadow-black shadow-2xl">
        <img
